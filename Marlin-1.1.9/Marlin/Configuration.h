...
#define STRING_SPLASH_LINE2 "She's SKOOKUM!"         // will be shown during bootup in line 2
...
#define CUSTOM_MACHINE_NAME "Cockford-Ollie"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #define DEFAULT_Kp 83.59
  #define DEFAULT_Ki 6.67
  #define DEFAULT_Kd 261.94
